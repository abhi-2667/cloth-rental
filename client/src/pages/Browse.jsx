  ...
  return (
    <div>
      <div style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <h1 style={{ fontSize: '2rem', marginBottom: '0.25rem' }}>Catalog</h1>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.92rem' }}>Filter by gender, occasion, availability, price, and date to find event-ready pieces faster.</p>
        </div>
        <div className="flex gap-2">
          {['', 'wedding', 'party', 'casual'].map(cat => (
            <button 
              key={cat}
              className={`btn ${occasionFilter === cat ? 'btn-primary' : 'btn-outline'}`}
      ...
      <div className="glass" style={{ padding: '1rem', marginBottom: '2rem', display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1rem' }}>
      ...
      <div className="glass" style={{ padding: '1rem', marginBottom: '2rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '1rem' }}>
        <div className="form-group" style={{ marginBottom: 0 }}>
          <label>Gender</label>
          <select
            className="form-control"
